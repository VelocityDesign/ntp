...
const settingsClose = () => {
  document
    .getElementById('settings-container')
    .setAttribute('class', 'settings-container settings-close');
};
...
const refreshChecks = () => {
  if (window['checked'] == 0) {
    document
      .getElementsByClassName('checkbox-big')[0]
      .setAttribute('class', 'checkbox-big');
    document
      .getElementsByClassName('checkbox-big')[1]
      .setAttribute('class', 'checkbox-big checkbox-inactive');
  }
  if (window['checked'] == 1) {
    document
      .getElementsByClassName('checkbox-big')[1]
